...
task      = 'tss';% 'aurora_test';   % 'sl', 'ath', 'tss', 'tth', 'tss_a'
batch_tag = 'gp'; %'yb_noexclusion_full_200ms_individ_bl'; %'_yb_v6_2';%_yb_replicate_happe+er_2022-08-18_gp_2'; %reseg_blcorr';    % tag for saving batch file
computer  = 'pc';    % 'pc' or 'mac', for filepaths
run_tag   = '25hzLP_32hzNF';%'seg_.1_100_200msblcorr; %'full_.1_30_noblcorr';%'seg_.1_30';%run_08_09_22_at_04_14_16';%'full_.1_30_blcorr';%'2hz_test';
